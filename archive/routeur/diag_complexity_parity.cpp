...
int main(int argc, char** argv) {
    ...
    double noiseTol = 0.40, discoverCount = argc > 2 ? atoi(argv[2]) : max(300, 3*n);
    string trainPath = "../data/Parity" + to_string(muxSize) + "TrainingData.txt";
    string testPath  = "../data/Parity" + to_string(muxSize) + "TestData.txt";
    ...
    cout << "Parity" << muxSize << " -- complexite totale (litteraux Include, M=" << M << ") : " << totalLit << "\n";
    cout << "Parity" << muxSize << " -- noeuds routeur totaux : " << totalNodes << "\n";
    ...
    cout << "Parity" << muxSize << " -- complexite de decision moyenne / prediction : " << avgComplexity << "\n";
